...
public class SearchAlgo {
    ...
    public static void main(String args[])
    {
        ...
        while(true){
            ...
            if (searchitem.equals("q")) break;
            location=search(searchitem);
            if (location==-1)c.println("Product not found.");
            else{
                c.println("Here is the info for " + searchitem);
                c.println("-------------------------------------------");
                c.println("Price: " + price[location]);
                c.println("Category: " + category[location]);
